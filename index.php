...
<head>
  ...
  />
    ...
    <style>
        ...
        .dropdown-content.drop-cintainer {
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <!-- categories -->
            <?php
            include("section/categories-slid.php")
            ?>
            ...
            <!-- special offers -->
            <?php
            include("section/special-offer.php")
            ?>

            <!-- cabe -->
            <?php
            include("section/categories-tab.php")
            ?>
            ...
            <!-- blogs -->
            <?php
            include("section/blogs.php")
            ?>

            <!-- Review -->
            <?php
            include("section/review-home.php")
            ?>
