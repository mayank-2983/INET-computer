<?php
    ...
    if (isset($_POST['b_id'])){
        ...
        $sql = "SELECT * from product , categories , brand where product.c_id = categories.c_id and product.b_id = brand.b_id and product.Status = 'active' and product.`b_id`=$bid";
