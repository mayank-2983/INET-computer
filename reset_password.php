                            ...
                            <div class="card mt-5 login-bg">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <h3 class="text-dark mt-3">Reset Password</h3>
                                    </div>

                                    <form action="login_register.php" method="post" class="p-2 mt-3" id="forgotPassword">

                                        <!-- <input type="hidd" name="email" value="<?= $email ?>"> -->
                                        <div class="mb-3">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="text" disabled autocomplete="off" name="email" id="email" class="form-control" value="<?= $email ?>" />

                                        </div>
                                        <div class="mb-3">
                                            <label for="pwd" class="form-label">New Password</label>
                                            <input type="password" required autocomplete="off" name="new_password" id="pwd" class="form-control" placeholder="Password" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" required autocomplete="off" name="password" id="c_pwd" class="form-control" placeholder="Confirm Password" />
                                            <span class="error" id="Conpassword-error"></span>

                                        </div>

                                        <div class="mt-4">
                                            <input type="submit" name="resetPwd" value="Reset" class="btn btn-primary w-100" />
                                        </div>
                                    </form>
                                </div>
                    ...
                    errorPlacement: function(error, element) {
                        ...
                        switch (element.attr("name")) {
                            case "new_password":
                                ...
                                break;
                            case "password":
                                error.appendTo("#Conpassword-error");
                                break;
                        }
                    }
                })
