...
<body>
    ...
    <div class="main-content">
        ...
        <?php 
            $b_q=mysqli_query($con,"SELECT * FROM categories where c_id='$c_id'");
            $c_name=mysqli_fetch_array($b_q);
                    ...
                    <div class="r row">
                        <div class="col-sm-12 col c">
                            <ul>
                                ...
                                <li><?=$c_name['CTitle'] ?> products</li>
                            </ul>
                            <h1><?=$c_name['CTitle'] ?> products</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="search-cont">
                ...
                <div class="container">
                    ...
                    <input type="hidden" name="c_id" class="c_id" id="c_id" value="<?= $c_id ?>">
                                             ...
                                             <div class="filter-list">
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($categories)) {
                                                        ...
                                                        $no_of_product = mysqli_query($con," SELECT * from product , categories , brand where product.c_id = categories.c_id and product.b_id = brand.b_id and product.`b_id`=$bid and product.`c_id`=$c_id and product.Status = 'active'");
                                                        $b=0;
