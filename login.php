...
<head>
    ...
    <title>Inet Conputer | login</title>
                                ...
                                <form id="LoginForm" action="login_register.php" method="post" class="p-2 mt-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            ...
                                            <!-- <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon"><i class="bi bi-eye"></i></button> -->
                                            <span class="error" id="password-error"></span>
                                        </div>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="check" value="yes" id="exampleCheck1" />
                                        <label class="form-check-label" for="auth-remember-check">Remember me</label>
                                        <b><span class="spancheck"></span></b>
                                        <a href="forgot_password_email.php" class="text-muted float-end">Forgot password?</a>
                                    </div>
