        ...
        <div class="col-12">
            ...
            <div class="swiper mySwiper3">
                <div class="swiper-wrapper"  >
                    <?php 
                        $trending = mysqli_query($con,"SELECT * from product , categories , brand where product.c_id = categories.c_id and product.b_id = brand.b_id and product.Status = 'active' and product.trending = 1  ");
