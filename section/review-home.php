                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-7">
                            <div class="sec-head text-center">
                                <h1 class="fw-bold">Real talk from our real customers</h1>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-3">
                            <div class="company-rev">
                                <div class="rev-logo">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 255.2 80.3"
                                ...
                                <div class="rev-txt">
                                    ...
                                    <?php
                                        ...
                                        $review = mysqli_query($con,"SELECT * FROM `productreview` ORDER BY `productreview`.`review_date` DESC");
                                        $c=0;
                                        $sum_str=0;
                                        if ($review) {
                                    ...
                                    <h2>EXCELLENT</h2>
                                    <p>Based on <strong><?= $c ?> reviews</strong> </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-9">

                            <div class="swiper mySwiperrvw swip-pad">
                                <div class="swiper-wrapper">
                                    
                                    <?php
                                        $review2 = mysqli_query($con,"SELECT * FROM `productreview` ORDER BY `productreview`.`review_date` DESC limit 10");
                                        while($rev = mysqli_fetch_array($review2)) {
                                    ?>
                                    
                                    <div class="swiper-slide">
                                        <div class="rev-box">
                                            <div class="rev-box-hed">
                                                <div class="rev-usr-img">
                                                    <img src="img/review/r1.png" alt="">
                                                </div>
                                                <div class="rev-usr-name">
                                                    <h4><?= $rev['Name'] ?></h4>
                                                    <p><?= $rev['review_date'] ?></p>
                                                </div>
                                            </div>
                                            <div class="rev-box-txt">
                                                <div class="rev-box-txt-retting">
                                                    <?php
