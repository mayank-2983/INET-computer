...
<?php
    ...
    $qry = mysqli_query($con,"SELECT * from brand WHERE brand.b_id=$b_id ");
...
<section class="main my-5">
        <div class="container">
            ...
            <div class="row">
              ...
              <?php 
                 $qry = mysqli_query($con,"SELECT * from product , categories , brand where product.c_id = categories.c_id and product.b_id = brand.b_id and product.`b_id`=$b_id");
