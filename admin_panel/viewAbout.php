    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            <div class="card-box mb-30">
                <h2 class="h4 pd-20">About</h2>
                <div class="d-flex justify-content-between align-items-center mb-3 px-3">
                    <div class="add-btn">
                        <a class="btn btn-success" href="addAbout.php">Add</a>
                    </div>
                    <div class="add-search">
                        <!-- <form> -->
                        <div class="form-group mb-0 position-relative">
                            <i class="dw dw-search2 search-icon"></i>
                            <input type="text" class="form-control search-input" id="blog-search" placeholder="Search Here" autocomplete="off">
                        </div>
                        <!-- </form> -->
                    </div>
                </div>

                <table class="data-table table nowrap" id="table-blog">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <?php
                        $blog = mysqli_query($con, "SELECT * FROM about");
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="table-plus">
                                    <img src="<?php echo '../uploads/about/' . $row['Image']; ?>" width="70" height="70" alt="" />
                                </td>
                                <td><?= substr($row['Discription'],0,100 ).'...'?> </td>
                                <td><?= $row['Column_rev'] ?></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <a class="dropdown-item" href="editAbout.php?ab_id=<?= $row['ab_id'] ?>"><i class="dw dw-edit2"></i> Edit</a>
                                            <a class="dropdown-item" href="deleteAbout.php?ab_id=<?= $row['ab_id'] ?>"><i class="dw dw-delete-3"></i> Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
