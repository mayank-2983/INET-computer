...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <?php 
            $b_q=mysqli_query($con,"SELECT * FROM brand where b_id='$b_id'");
            $b_name=mysqli_fetch_array($b_q);
                    ...
                    <div class="r row">
                        <div class="col-sm-12 col c">
                            <ul>
                                ...
                                <li><?=$b_name['BTitle'] ?> products</li>
                            </ul>
                            <h1><?=$b_name['BTitle'] ?> products</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="search-cont">
                ...
                <div class="container">
                    ...
                    <input type="hidden" name="b_id" class="b_id" id="b_id" value="<?= $b_id ?>">
                                            ...
                                            <div class="filter-list">
                                                ...
                                                <?php
                                                    ...
                                                    while($data = mysqli_fetch_array($categories)) {
                                                        ...
                                                        $no_of_product = mysqli_query($con," SELECT * from product , categories , brand where product.c_id = categories.c_id and product.b_id = brand.b_id and product.`c_id`=$cid and product.`b_id`=$b_id and product.Status = 'active'");
                                                        $s=0;
